...
# ======================================================
# STEP-10: EXPORT 3D PATH TO MISSION PLANNER
# ======================================================

print("\nSTEP 10: Exporting to Mission Planner...")

from pyproj import Transformer

ALTITUDE_DEFAULT = 30.0
OUTPUT_FILE = "mission_planner_export.waypoints"

# Make sure path exists
if path_3d is None:
    raise Exception("No path found. Cannot export.")

# UTM (32643) -> WGS84 converter
...
with open(OUTPUT_FILE, "w") as f:
    ...
    for x, y, z in path_world:
        ...
        altitude = z if z > 0 else ALTITUDE_DEFAULT
